    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        dialog.setPositiveButton("Save",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        {
                            assert getArguments() != null;
                            ((DriveActivity) Objects.requireNonNull(getActivity())).saveDialogEntry(getArguments().getInt("title_id"), data);
                        }
                    }
                });
        ...
        dialog.setNegativeButton("Resume", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ((DriveActivity) Objects.requireNonNull(getActivity())).resumeDrive();
